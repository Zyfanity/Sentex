...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (token) {
      // UPDATED: Changed storage keys to sentex branding
      ...
      <div className="login-card glass-panel">
        <div style={{
          ...
          <span style={{ 
            ...
            {/* UPDATED: Changed 'Z' to 'S' for Sentex */}
            S
          </span>
        </div>
        
        {/* UPDATED: Header already said SENTEX in your snippet, kept for consistency */}
        <h2 className="brand-text-glow" style={{ margin: 0, paddingBottom: '5px' }}>SENTEX</h2>
