        ...
        <div className="glass-panel" style={{ flex: '1 1 400px', padding: '24px', background: 'rgba(43, 45, 49, 0.4)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <div style={{ display: 'flex', gap: '16px' }}>
              {/* UPDATED: Visual Initial to S */}
              <div style={{ minWidth: '40px', height: '40px', borderRadius: '50%', background: '#5865F2', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}>S</div>
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '4px' }}>
                  {/* UPDATED: Visual Text to Sentex */}
                  <span style={{ color: formData.color, fontWeight: '600', fontSize: '1.05rem' }}>Sentex</span>
